...
import Setting from "./src/screens/auth/settings";
        ...
        <HomeStack.Screen
            ...
            options={({ route }) => ({
                ...
                headerLeft: () => (
                    ...
                    >
                        <AntDesign name="left" size={24} color="black" style={{ padding: 5 }} />
                    </TouchableOpacity>
                ),
            })} />
    </HomeStack.Navigator>
...
const ProfileStackScreen = ({ navigation }) => (
    <ProfileStack.Navigator screenOptions={{
        ...
        <ProfileStack.Screen name="Settings" component={Setting} options={{
            title: 'Paramètres'
        }} />
...
const TabsScreen = () => (
    ...
    >
        ...
        <Tabs.Screen name="ProfileTab" component={ProfileStackScreen} options={{
            headerShown: false,
            tabBarLabel: 'Profile',
            tabBarIcon: ({ color, size }) => (
